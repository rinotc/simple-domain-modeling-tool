...
case class Project(projectId: String, projectAlias: String, projectName: String, projectOverview: String) {
...
object Project extends SQLSyntaxSupport[Project] {
  ...
  def create(projectId: String, projectAlias: String, projectName: String, projectOverview: String)(implicit
      session: DBSession = autoSession
  ): Project = {
    withSQL {
      insert
        .into(Project).namedValues(
